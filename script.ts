...
function matin(arr:string[]):string{
    return arr.join(',');
}
const massiv:string[]=["hello","typescript"];
console.log(matin(massiv))


/// 3- masalal tupledan malumotlarni qabul qilib consolga chiqarish
const tupleType:[username:string,loginTime:Date,isLoggedIn:boolean]=['fazliddin',new Date(),true];
